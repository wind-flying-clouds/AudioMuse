...
public extension LNPopupItem {
    ...
    var attributedTitle: AttributedString? {
        get {
            __attributedTitle != nil ? AttributedString(__attributedTitle.unsafelyUnwrapped) : nil
        }
        set {
    ...
    var attributedSubtitle: AttributedString? {
        get {
            __attributedSubtitle != nil ? AttributedString(__attributedSubtitle.unsafelyUnwrapped) : nil
        }
        set {
...
public extension LNPopupBarAppearance {
    ...
    var titleTextAttributes: AttributeContainer? {
        get {
            __titleTextAttributes != nil ? AttributeContainer(__titleTextAttributes.unsafelyUnwrapped) : nil
        }
        set {
    ...
    var subtitleTextAttributes: AttributeContainer? {
        get {
            __subtitleTextAttributes != nil ? AttributeContainer(__subtitleTextAttributes.unsafelyUnwrapped) : nil
        }
        set {
...
public extension LNPopupBar {
    ...
    struct Placement: EnvironmentKey, UITraitBridgedEnvironmentKey {
        ...
        public static func read(from traitCollection: UITraitCollection) -> LNPopupBar.Environment {
            traitCollection.popupBarEnvironment
        }

        public static func write(to _: inout any UIMutableTraits, value _: LNPopupBar.Environment) {}
    }
}

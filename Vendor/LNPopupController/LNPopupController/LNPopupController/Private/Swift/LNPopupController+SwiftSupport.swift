//
//  LNPopupController+SwiftSupport.swift
//  LNPopupController
//
...
extension UIView {
    ...
    private static func __fixUIHostingViewHitTest() {
    ...
    private static func __animateUsingSwiftUI(duration: TimeInterval, changes: @escaping () -> Void, completion: (() -> Void)? = nil) {
    ...
    private static func __animateInteractiveUsingSwiftUI(duration: TimeInterval, changes: @escaping () -> Void, completion: (() -> Void)? = nil) {
        if #available(iOS 18.0, *) {
